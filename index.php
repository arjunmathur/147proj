...
<html>
    ...
    <body>
        ...
        <div data-role="page" style="background: #000000 url('GrouPS_background.png') repeat;" id="nav_overview" data-theme="a">
			...
			<div data-role="popup" id="help" data-overlay-theme="a" data-theme="c" style="max-width:400px;" class="ui-corner-all">
				...
				<div data-role="content" data-theme="a" class="ui-corner-bottom ui-content">
					...
					<p><FONT COLOR="FFFFFF"> To create a new Group Navigation, click <strong></FONT><FONT COLOR="38C5FC">Start New Navigation. </strong></FONT><FONT COLOR ="FFFFFF"> To join a group someone else created, find it under the </FONT><strong><FONT COLOR="38C5FC">Navigation Requests</strong></FONT><FONT COLOR ="FFFFFF"> header. Once you have entered a destination in the search field, tap on the pin to view more information and to navigate to that location.</FONT></p>
